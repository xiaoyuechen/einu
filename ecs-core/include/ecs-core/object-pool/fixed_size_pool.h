...
inline FixedSizePool<T, Allocator>::FixedSizePool(std::size_t count,
...
template <typename T, typename Allocator>
template <typename... Args>
inline FixedSizePool<T, Allocator>::FixedSizePool(
...
template <typename T, typename Allocator>
inline std::size_t FixedSizePool<T, Allocator>::Size() const noexcept {
  return object_arr_.size();
}

template <typename T, typename Allocator>
inline std::size_t FixedSizePool<T, Allocator>::FreeSize() const noexcept {
...
template <typename T, typename Allocator>
inline void FixedSizePool<T, Allocator>::Recall(const T& obj) {
